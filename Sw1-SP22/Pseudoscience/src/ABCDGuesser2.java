...
public final class ABCDGuesser2 {
    ...
    //private method that adds percentage
    private static void percent(SimpleReader in, SimpleWriter out) {
        out.println("%.");
    }
    ...
    public static void main(String[] args) {
        ...
        // okay now that its for loops its taking less space
        for (int a = 0; a < charmLength; a++) {
            //w^a
            double num1 = Math.pow(w, charmDigits[a]);
            for (int b = 0; b < charmLength; b++) {
                //x^b
                double num2 = Math.pow(x, charmDigits[b]);
                for (int c = 0; c < charmLength; c++) {
                    //y^c
                    double num3 = Math.pow(y, charmDigits[c]);
                    for (int d = 0; d < charmLength; d++) {
                        //z^d
