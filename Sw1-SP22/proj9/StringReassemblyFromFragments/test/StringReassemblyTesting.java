...
//    @Test
    //Routine
    // I am not sure how to successfully test this method out
//    public void testLinesFromInput() {
//        Set<String> test = new Set1L<String>();
//        Set<String> result = new Set1L<String>();
//        SimpleReader input = new SimpleReader1L("data\test1.txt");
//        result.add(StringReassembly.linesFromInput(input));
//        test.add(StringReassembly.linesFromInput(input));
//        assertTrue(test.isSubset(result));
//        assertTrue(result.isSubset(test));
//
//    }
    ...
    public void testprintWithLineSeparators() {
        String text = "22312edz~w34";
        SimpleWriter out = new SimpleWriter1L();
        //this shall replace ~ with line separator
        StringReassembly.printWithLineSeparators(text, out);
    }

    @Test
    //challenging because there were no seperators
    public void testprintWithLineSeparators1() {
        String text = "22312edzw34";
        SimpleWriter out = new SimpleWriter1L();
        //this shall replace ~ with line separator
        StringReassembly.printWithLineSeparators(text, out);
    }
    ...
    @Test
    //challenging because there were is only one serperator with other type of
    //symbols this can also be boundary test
    public void testprintWithLineSeparators2() {
        String text = "SSSSSSSDA$%#$@!@#~$#&()_+=-9-";
        SimpleWriter out = new SimpleWriter1L();
        //this shall replace ~ with line separator
        StringReassembly.printWithLineSeparators(text, out);
    }
    ...
    @Test
    //challenging because there is no input, trying to crash method
    ...
    public void testprintWithLineSeparators4() {
        String text = "~~~~~d32r~~~f34r~Fd43~~~$324re4l;465~]][]";
        SimpleWriter out = new SimpleWriter1L();
        //this shall replace ~ with line separator
        StringReassembly.printWithLineSeparators(text, out);
    }
