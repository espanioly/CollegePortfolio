...
public final class Newton4 {
    ...
    public static void main(String[] args) {
        ...
        while (root0 >= 0) { // checks if user wants to use the program
            ...
            out.println("The answer I got is: " + sqrt(root0, root1, root2)); // e gets computed in the method
            //this is not needed anymore out.print("Please enter 'y' to continue "); // confirms that the users wants to keep going
            root0 = root0 * -1;

        }
        out.println("Quitting program.... Thank You!");
        /*
