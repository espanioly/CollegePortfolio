...
void printFinal(Node *start){
	...
	start->student.Final_Grade = (.15*start->student.cat1.cum)+(.3*start->student.cat2.cum)+(.2*start->student.cat3.cum)+(.35*start->student.cat4.cum);
	printf("	%.2f",start->student.Final_Grade);
}
