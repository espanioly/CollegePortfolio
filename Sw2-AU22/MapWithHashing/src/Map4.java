...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public Map4() {
        /*
         * Create new rep with a hashtable using the default hash table size
         */
    ...
    public Map4(int hashTableSize) {
        /*
         * Create new rep using the value in hashTableSize
         */
    ...
    public final Pair<K, V> removeAny() {
        ...
        int bucket = -1, i = 0;
        /*
         * iterative check from each bucket to find a bucket that has a map and
         * return any key and pair in that map.
         */
        while (bucket <= -1) {
