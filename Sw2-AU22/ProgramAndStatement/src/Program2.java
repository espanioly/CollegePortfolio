...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        /*
         * Create reps for body and statement using Statement1 and Map1L
         */
    ...
    public final void setName(String n) {
        ...
        /*
         * Update this.name rep to hold the incoming name from {@Code n);
         */
        this.name = n;
    }
    ...
    public final String name() {
        /*
         * return the name of the program. "unnamed" if it has not been named.
         */
        return this.name;
    }
    ...
    public final Map<String, Statement> newContext() {
        ...
        // Return a new object of dynamic type Map1L<String, Statement>
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /**
         * Create new temporary map to hold contents of this.context
         */
        Map<String, Statement> tempCtxt = new Map1L<>();
        /*
         * Transfer this.context to the temporary map
         */
        tempCtxt.transferFrom(this.context);
        /*
         * Transfer the contents of c to this.context
         */
        this.context.transferFrom(c);
        /*
         * Transfer the contents of this.context to c
         */
        c.transferFrom(tempCtxt);
    ...
    public final Statement newBody() {
        /*
         * Return a new object of dynamic type Statement1
         */
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Create a new body of type Statement
         */
        Statement tempBody = new Statement1();
        /*
         * Transfer the contents of this.body to the temporary body
         */
        tempBody.transferFrom(this.body);
        /*
         * Transfer the contents of b to this.body
         */
        this.body.transferFrom(b);
        /*
         * Transfer the contents of the tempBody to b
         */
