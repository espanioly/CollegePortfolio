...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Create node that will hold the incoming data and alias node for
         * lastLeft
         */
        Node p = new Node();
        Node q = this.lastLeft.next;
        /*
         * Place the node at the right front, updating and fixing next and
         * previous of each node
         */
        p.data = x;
        q.previous = p;
        ...
        /*
         * Update the length of the right side
         */
        this.rightLength++;
        assert this.conventionHolds();
    }
    ...
    public final T removeRightFront() {
        ...
        Node q = p.next;
        /*
         * Get the data being removed
         */
        T x = p.data;
        /*
         * Update next and previous nodes to remove the right front
         */
        this.lastLeft.next = q;
        q.previous = this.lastLeft;
        /*
         * Update length of right side
         */
        this.rightLength--;
        assert this.conventionHolds();
        return x;
    ...
    public final void advance() {
        ...
        /*
         * Advance the this.LastLeft
         */
        this.lastLeft = p.next;
        /*
         * Update the lengths of left and right
         */
        this.leftLength++;
        this.rightLength--;
        assert this.conventionHolds();
    ...
    public final void moveToStart() {
        /*
         * Update this.LastLeft to be empty
         */
        this.lastLeft = this.preStart;
        /*
         * Update the lengths of left and right side
         */
    ...
    public final void moveToFinish() {
        /*
         * Update the position of this.lastLeft to whichever node comes before
         * postFinish
         */
        this.lastLeft = this.postFinish.previous;
        /*
         * Update the length of left and right side
         */
    ...
    public final void retreat() {
        ...
        /*
         * Update lastLeft to the node immediately to its left
         */
        this.lastLeft = this.lastLeft.previous;
        /*
         * Update the length of the left and right side
         */
        this.rightLength++;
        this.leftLength--;
        assert this.conventionHolds();
